...
Follow these steps to deploy or run Awasthi Labs locally.

### 1. Clone the Repository
```bash
git clone https://github.com/Anmolawasthi117/Awasthi-Labs.git
cd Awasthi-Labs
```
...
VITE_MEDIUM_URL="https://medium.com/@anmolawasthi117"
```
...
Feel free to reach out via [anmolawasthi117@gmail.com](mailto:anmolawasthi117@gmail.com)

---
*Built with ❤️ by Anmol Awasthi. 2026.*
