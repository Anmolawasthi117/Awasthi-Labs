            ...
            <div className="flex items-start justify-between group cursor-pointer">
              <div className="flex gap-4">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    {exp.type && (
                      <span className="px-1.5 py-0.5 text-[10px] uppercase font-medium bg-zinc-900 border border-zinc-800 rounded text-zinc-400">
                        {exp.type}
                      </span>
                    )}
                  </div>
              ...
              <div className="flex gap-4 items-start">
                 ...
                 {exp.highlights.length > 0 ? (
                    <ChevronUp className="h-4 w-4 text-zinc-600 mt-0.5" />
                 ) : (
                    <ChevronDown className="h-4 w-4 text-zinc-600 mt-0.5" />
                 )}
              </div>
            </div>
